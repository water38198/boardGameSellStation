...
<template>
  ...
  <div class="bg-b20">
    ...
    <main>
      <!-- 最新消息 -->
      <div class="news">
        <div class="container py-7 bg-white rounded-2">
          <div class="row justify-content-end">
            <div
              class="d-none d-lg-block col-lg-6 news-image"
            ></div>
            <div class="col-lg-6">
              <template v-if="articles">
                <h2 class="fs-2 text-theme ps-2 mb-4">最新消息</h2>
                <ul class="list-group list-group-flush">
                  <li v-for="(article, index) in filterArticles('新聞', 5)"
      ...
      <section class="bg-white py-5">
        <div class="container">
          ...
          <div class="row">
            <div class="col-12"
            v-for="(article, index) in filterArticles('心得', 3)" :key="article.id" data-aos="fade-up"
          ...
          <div class="row">
            <div class="col-12"
            v-for="(article, index) in filterArticles('開箱', 3)" :key="article.id" data-aos="fade-up"
              :data-aos-duration="1000 + 250 * index">
              <RouterLink :to="`/article/${article.id}`" class="text-decoration-none text-black">
                <div class="card mb-5 border-0 bg-b10">
                  <div class="row g-0">
                    <div class="col-md-4">
                      <img :src="article.image" class="rounded-start" alt="articleImage"
            ...
            <div class="text-center my-4 my-xl-5">
              <RouterLink to="/articles/unboxings" class="btn btn-lg btn-be4 text-b60 rounded-0">
                更多開箱</RouterLink>
            </div>
          </div>
        </div>
