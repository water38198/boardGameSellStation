  ...
  >
    <div class="modal-content">
      ...
      <div class="modal-body">
        <VForm @submit="updateArticle()" v-slot="{ errors }" class="row" id="articleForm">
          <div class="col-4">
            <div class="mb-5">
              <label for="image" class="form-label">封面</label>
              <input type="text" placeholder="請輸入圖片連結" id="image"
                class="form-control mb-2" v-model="newArticle.image"/>
              <div class="mb-3">
                <input class="form-control" type="file" id="uploadImage"
                  @change="uploadImage()" :disabled="loadingItem === 'uploadImage'"/>
              </div>
              <div class="text-center">
                <img :src="newArticle.image" alt="article image" class="img-fluid article-cover"/>
              </div>
            </div>
          </div>
          <div class="col-8">
            <div class="row gy-3">
              <div class="col-6">
                ...
                <VField id="articleTitle" name="文章標題" type="text"
                  class="form-control" :class="{ 'is-invalid': errors['文章標題'] }"
                  placeholder="請輸入 文章標題" rules="required" v-model="newArticle.title"></VField>
              ...
              <div class="col-6">
                ...
                <VField id="articleCategory" name="文章分類" class="form-select"
                  ...
                  rules="required" v-model="newArticle.category" as="select">
              ...
              <div class="col-4">
                ...
                <VField id="articleAuthor" name="作者" type="text" class="form-control"
                  ...
                  rules="required" v-model="newArticle.author"></VField>
              ...
              <div class="col-8">
                ...
                <VField id="articleDescription" name="敘述" type="text" class="form-control"
                  ...
                  v-model="newArticle.description"></VField>
              ...
              <div class="col-4">
                ...
                <div class="form-check form-switch d-flex align-items-center">
                  <input class="form-check-input me-2" type="checkbox" role="switch"
                    id="isPublic" v-model="newArticle.isPublic"/>
                  <label class="form-check-label fs-5 text-primary" for="isPublic"
                    v-if="newArticle.isPublic">公開</label>
      ...
      <div class="modal-footer">
        ...
        <button
          ...
          :disabled="loadingItem === 'confirmButton'" form="articleForm"
          >確認</button>
      </div>
    </div>
  </div>
