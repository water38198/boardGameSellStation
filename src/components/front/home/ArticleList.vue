...
<template>
  <section class="bg-white pt-5 pb-4">
    <div class="container">
      ...
      <div class="row">
        <div class="col-12" v-for="(article, index) in articles" :key="article.id" data-aos="fade-up" :data-aos-duration="1000 + 250 * index">
            ...
            <div class="card mb-5 border-0 bg-b10">
              <div class="row g-0">
                ...
                <div class="col-12 col-md-8">
                  <div class="card-body d-flex flex-column justify-content-center h-100 mx-md-5">
        ...
        <div class="text-center my-4 my-xl-5">
          <RouterLink to="/articles?category=心得" class="btn btn-lg btn-gray300 text-gray400 rounded-0">
            更多心得</RouterLink>
        </div>
      </div>
    </div>
