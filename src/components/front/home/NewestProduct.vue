  ...
  <div class="wrapper">
    <div class="container py-5 my-xl-5">
      <h2 class="fs-1 mb-5 d-flex justify-content-between">
        最新上架
        <RouterLink to="/products" class="btn btn-gray300 text-gray400 fs-4">更多商品</RouterLink>
      </h2>
      <div class="row g-3">
        <div class="col-12 col-lg-4" v-for="(product,index) in products.slice(0, 3)" :key="product.id" data-aos="zoom-in" :data-aos-duration="1000 + 250 * index">
          <RouterLink :to="`/product/${product.id}`" class="text-decoration-none text-black">
            <div class="card">
              <div class="row">
                <div class="col-md-6 col-lg-12">
                  <img :src="product.imageUrl" class="card-img-top d-block home-product-image" :alt="product.title">
                </div>
                <div class="col-md-6 col-lg-12">
